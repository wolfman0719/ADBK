...
If Not Install("Address Book Demo Application", _
                VisM1, _
                "GLO", "^ADBK", "ISJSAMPLES", _
                    "+'$D(^$ROUTINE(""ADBK""))", _
                    "adbk.gsa", _
                "MAC", "ADBK", "ISJSAMPLES", _
                    "+'$D(^$ROUTINE(""ADBK""))", _
                    "adbk.rsa") Then End
End Sub
...
Private Sub VisM1_Executed()

If VisM1.P9 <> "" Then
status = MsgBox("データエラー　" & VisM1.P9, vbOKOnly, "データエラー")
End If
End Sub

Private Sub VisM1_OnError()
status = MsgBox("Cache'　Direct　Error　" & VisM1.ErrorName, vbOKOnly, "Cache'　Direct　Error")
