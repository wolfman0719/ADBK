...
Friend Class FindByName
	...
	Dim Adapter As IRISDataAdapter
	Dim Builder As IRISCommandBuilder
	Dim DataSet As System.Data.DataSet
	Dim ADBKTable As System.Data.DataTable
	...
	Public Function ShowDialog_Renamed(ByRef conn As IRISConnection) As System.Data.DataSet
	...
	Private Sub CmdFind_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles CmdFind.Click
		...
		If TxtSNAME.Text = "" Then
			...
			SQLtext = "Select ANAME from ADBK"
			Adapter = New IRISDataAdapter(SQLtext, iris_conn)
			Adapter.TableMappings.Add("Table", "ADBK")
			Builder = New IRISCommandBuilder(Adapter)
			DataSet = New System.Data.DataSet()
			Adapter.Fill(DataSet)
			ADBKTable = DataSet.Tables.Item("ADBK")

		Else
			'rs.Open("Select ANAME from ADBK WHERE ANAME %STARTSWITH '" & TxtSNAME.Text & "'", cnn1)
			SQLtext = "Select ANAME from ADBK WHERE ANAME %STARTSWITH ?"
		...
		For Each ADBKRow As System.Data.DataRow In ADBKTable.Rows
			ListLookupName.Items.Add(ADBKRow.Item("ANAME"))
		Next
